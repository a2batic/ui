describe("Unit Component: GlobalTaskDetailList", function() {
    ...
    describe("Task List workflows", function() {
        ...
        /*        it("Should go to cluster detail", function() {
                    vm.goToClusterDetail();
                    expect($state.go.calledWith("cluster-hosts", { clusterId: globalTaskDetail.jobDetails.parameters["TendrlContext.integration_id"] })).to.be.true;
                });WIP
        */
